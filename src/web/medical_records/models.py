...
class MedicalRecord(models.Model):
    patient = models.ForeignKey(
        User, related_name="medical_record_patient", on_delete=models.CASCADE)
    doctor = models.ForeignKey(
        User, related_name="medical_record_doctor", on_delete=models.CASCADE)
    ...
    report = models.FileField(
        upload_to='medical_records/', blank=True, null=True)
